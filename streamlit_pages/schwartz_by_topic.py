...
def app():
    ...
    **What is 'Human Value Analysis'?**
    ...
    print_graph('data/graphs/Schwartz_Analysis/repartition_per_topic/global/model_merged_per_humanvalue_pct.html', width=1150, height=750)

    st.subheader("Topic-wise")
    # st.markdown("<h4 style='text-align: center; color: grey;'>By Emotion</h4>", unsafe_allow_html=True)
    print_graph('data/graphs/Schwartz_Analysis/repartition_per_topic/global/model_merged_per_humanvalue_class_pct.html', width=1150, height=750)
    ...
    st.subheader("Class-wise")
    print_graph(f'data/graphs/Schwartz_Analysis/repartition_per_topic/class_by_human_values/by_{groupby_option}/{value}_pct.html',width=1500, height=750)
    st.subheader("Topic-wise")
    print_graph(f'data/graphs/Schwartz_Analysis/repartition_per_topic/class_by_human_values/by_{groupby_option}/{value}_class_pct.html',width=1500, height=750)
