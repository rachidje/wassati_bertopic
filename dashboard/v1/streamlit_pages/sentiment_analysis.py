...
def app():
    ...
    **3 - Emotion-specific Analysis**:
    ...
    # with tab1:
    #     print_graph('dashboard/data/graphs/Sentiment_Analysis/by_sentiment/repartition_per_topic/global/model_merged_per_sentiment_class_pct.html', height=750, width=1000)
    ...
    #     with col1:
    #         # st.markdown("<h4 style='text-align: center; color: grey;'>By Sentiment</h4>", unsafe_allow_html=True)
    #         print_graph('dashboard/data/graphs/Sentiment_Analysis/by_sentiment/repartition_per_topic/global/model_merged_per_sentiment_class_pct.html', width=500, height=750)
    #     with col2:
    #         # st.markdown("<h4 style='text-align: center; color: grey;'>By Emotion</h4>", unsafe_allow_html=True)
    ...
    #     paths = [f'dashboard/data/graphs/Sentiment_Analysis/by_emotion/repartition_per_topic/class_by_emotions/by_{groupby_option}/{value}.html',
    #             f'dashboard/data/graphs/Sentiment_Analysis/by_emotion/repartition_per_topic/class_by_emotions/by_{groupby_option}/{value}_pct.html']
    ...
    #     paths = [f'dashboard/data/graphs/Sentiment_Analysis/by_emotion/repartition_per_topic/emotion_by_class/by_{groupby_option}/{emotion}.html',
    #             f'dashboard/data/graphs/Sentiment_Analysis/by_emotion/repartition_per_topic/emotion_by_class/by_{groupby_option}/{emotion}_pct.html']
