...
def app():
    ...
    with tab1:
        ...
        # paths = ['dashboard/data/graphs/Descriptive_Analysis/score_repartition/score_distribution.html',
        #         'dashboard/data/graphs/Descriptive_Analysis/score_repartition/recommend_score_distribution.html']
        with col2:
