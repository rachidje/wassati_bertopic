...
def app():
    ...
    **What is 'Sentiment Analysis'?**
    ...
    print_graph(f'dashboard/data/graphs/Sentiment_Analysis/by_emotion/repartition_per_topic/emotion_by_class/by_{groupby_option}/new_{emotion}_pct.html',height=750)
    st.subheader("Topic-wise")    
    print_graph(f'dashboard/data/graphs/Sentiment_Analysis/by_emotion/repartition_per_topic/emotion_by_class/by_{groupby_option}/new_{emotion}_class_pct.html',height=750)
