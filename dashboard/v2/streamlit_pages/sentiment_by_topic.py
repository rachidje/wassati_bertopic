...
def app():
    ...
    **What is 'Sentiment Analysis'?**
    ...
    with col1:
        ...
        print_graph('dashboard/data/graphs/Sentiment_Analysis/by_sentiment/repartition_per_topic/global/new_model_merged_per_sentiment_pct.html', width=700, height=750)
    with col2:
        # st.markdown("<h4 style='text-align: center; color: grey;'>By Emotion</h4>", unsafe_allow_html=True)
        print_graph('dashboard/data/graphs/Sentiment_Analysis/by_emotion/repartition_per_topic/global/new_model_merged_per_emotion_pct.html', width=1150, height=750)

    st.subheader("Topic-wise")
    col1, col2 = st.columns([1,1])
    with col1:
        # st.markdown("<h4 style='text-align: center; color: grey;'>By Sentiment</h4>", unsafe_allow_html=True)
        print_graph('dashboard/data/graphs/Sentiment_Analysis/by_sentiment/repartition_per_topic/global/new_model_merged_per_sentiment_class_pct.html', width=700, height=750)
    with col2:
        # st.markdown("<h4 style='text-align: center; color: grey;'>By Emotion</h4>", unsafe_allow_html=True)
        print_graph('dashboard/data/graphs/Sentiment_Analysis/by_emotion/repartition_per_topic/global/new_model_merged_per_emotion_class_pct.html', width=1150, height=750)
    ...
    st.subheader("Class-wise")
    print_graph(f'dashboard/data/graphs/Sentiment_Analysis/by_emotion/repartition_per_topic/class_by_emotions/by_{groupby_option}/new_{value}_pct.html',width=1500, height=750)
    st.subheader("Topic-wise")
    print_graph(f'dashboard/data/graphs/Sentiment_Analysis/by_emotion/repartition_per_topic/class_by_emotions/by_{groupby_option}/new_{value}_class_pct.html',width=1500, height=750)
